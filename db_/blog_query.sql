...
(1, 'HOD', '', 1, 1, NULL, '2023-03-15 02:41:42', '2023-03-17 05:11:02');

INSERT INTO `user_designations` (`id`, `designation_id`, `user_id`, `status`, `updated_by`, `created_at`, `updated_at`) VALUES 
(1, 1, 1, 1, 0, '2023-03-15 08:15:07', '2023-03-15 08:15:15');

INSERT INTO `user_logins` (`id`, `status`, `user_id`, `username`, `password`, `last_login_time`, `created_at`, `updated_at`) VALUES 
(1, 2, 1, 'admin@gmail.com', '123456', '2023-03-15 09:12:22', '2023-03-15 09:12:22', '2023-03-15 09:12:22');

INSERT INTO `user_types` (`id`, `name`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES 
(1, 'superadmin', 1, '', 0, '2023-03-15 08:15:49', NULL);

INSERT INTO `users` (`id`, `user_type_id`, `user_designation_id`, `first_name`, `last_name`, `mobile`, `email`, `gender`, `email_verified_at`, `address`, `country`, `state`, `city`, `pincode`, `status`, `created_by`, `updated_by`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'Admin', 'Admin', '8825171386', 'admin@gmail.com', 'Male', NULL, 'Srinagar', NULL, 0, 0, '85431', 1, NULL, 0, NULL, '2023-03-15 02:43:46', '2023-03-15 04:38:19');

INSERT INTO `categories` (`id`, `parent_id`, `title`, `icon`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 0, 'Category 1', NULL, 1, 1, NULL, '2023-03-17 06:04:16', '2023-03-17 06:04:16'),
(2, 0, 'Category 2', NULL, 1, 1, NULL, '2023-03-17 06:04:24', '2023-03-17 06:04:24'),
(3, 1, 'Sub category1-1', NULL, 1, 1, NULL, '2023-03-17 06:04:46', '2023-03-17 06:04:46'),
(4, 1, 'Sub category1-2', NULL, 1, 1, NULL, '2023-03-17 06:05:02', '2023-03-17 06:05:02'),
(5, 2, 'Sub category2-1', NULL, 1, 1, NULL, '2023-03-17 06:05:13', '2023-03-17 06:05:13'),
