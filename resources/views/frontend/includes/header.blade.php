...
<title>@yield('title') | CMS</title>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('assets/assets_web/vendor/animate.css/animate.min.css')}}" rel="stylesheet">
  ...
  <link href="{{ asset('assets/assets_web/vendor/remixicon/remixicon.css')}}" rel="stylesheet">
